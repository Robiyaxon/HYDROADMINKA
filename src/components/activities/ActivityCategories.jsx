...
import { getActivitiesCategories, getActivitiesCategoriesUpdate } from "../../redux/activities-reducer";
import { getActivitiesCategoriesCreate, getActivitiesCategoriesDelete } from './../../redux/activities-reducer';
                ...
                return (
                  <tr key={el.id}>
                    ...
                    <td>
                      ...
                      <DeleteBtn
                        handleAdd={() => dispatch(getActivitiesCategoriesDelete(el.id))}
                      />
                    </td>
                  </tr>
                );
