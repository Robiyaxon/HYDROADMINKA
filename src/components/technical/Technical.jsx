...
import { getTechnicalHeader, getTechnicalUpdate, getTechnicalCreate } from './../../redux/technical-reducer';
...
export const Technical = () => {
    ...
    const onSubmit = (data) => {
        !imageId ? dispatch(getTechnicalCreate({ selectedImage, title_uz: data.title })) : 
        dispatch(getTechnicalUpdate({ selectedImage, title_uz: data.title_uz, title_ru: data.title_ru, title_en: data.title_en, title_krl: data.title_krl, id: imageId.id, originalPath: imageId.photoUrl, selectedI }));
        setImageId(null)
        setSelectedI(false);
        setModalOpen(false);
    }
