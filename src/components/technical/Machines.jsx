...
//                     if (!values.description_krl) {
//                       errors.description_krl =
//                         "Invalid description Krl address";
//                     }
//                   }
//                   if (!values.amount1Discript) {
//                     if (!values.amount1Discript) {
//                       errors.amount1Discript =
//                         "Invalid amount Discript 1 address";
//                     }
//                   }
//                   if (!values.amount2Discript) {
//                     if (!values.amount2Discript) {
//                       errors.amount2Discript =
//                         "Invalid amount Discript 2 address";
//                     }
//                   }
//                   if (!values.amount3Discript) {
//                     if (!values.amount3Discript) {
//                       errors.amount3Discript =
//                         "Invalid amount Discript 3 address";
//                     }
//                   }
//                   if (!values.amount4Discript) {
//                     if (!values.amount4Discript) {
//                       errors.amount4Discript =
//                         "Invalid amount Discript 4 address";
//                     }
//                   }
//                   if (!values.amount1) {
//                     if (!values.amount1) {
//                       errors.amount1 = "Invalid amount 1 address";
//                     }
//                   }
//                   if (!values.amount2) {
//                     if (!values.amount2) {
//                       errors.amount2 = "Invalid amount 2 address";
//                     }
//                   }
//                   if (!values.amount3) {
//                     if (!values.amount3) {
//                       errors.amount3 = "Invalid amount 3 address";
//                     }
//                   }
//                   if (!values.amount4) {
//                     if (!values.amount4) {
//                       errors.amount4 = "Invalid amount 4 address";
//                     }
//                   }
//                   return errors;
//                 }}
