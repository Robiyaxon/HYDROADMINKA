...
import { getContactHeader, upDateContactHeaderText } from '../../redux/contact-reducer';
...
export default connect(mapStateToProps, {getContactHeader, upDateContactHeaderText})(Contact)