...
import { upDateContactHeaderPhoto, getContactImages, upDateContactPhoto } from './../../redux/contact-reducer';
...
export const GetPhoto = () => {
  ...
  const onSubmit = (data) => {
      // let a = selectedImage;
      // debugger
      dispatch(upDateContactPhoto({ selectedImage, title_uz: data.title, description_uz: data.description, id: imageId.id, originalPath: imageId.photoUrl, selectedI }));
      setImageId(null)
      setSelectedI(false);
      setModalOpen(false);
  }
